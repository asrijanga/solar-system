...
manager.onLoad = () => {
  // The button label is the confirmation; a progress bar frozen next to the word
  // "Ready" just looks like it stalled, so the whole indicator retires.
  loadbar.style.width = '100%';
  document.getElementById('loading').classList.add('done');
  const b = document.getElementById('launch'); b.disabled = false; b.textContent = 'Enter the system';
  document.getElementById('launch-flight').disabled = false;
};
...
// Primary action: straight into the system.
